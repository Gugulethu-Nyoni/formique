...
- html: ```html <div class="formique-note"> <h3> </h3> <small> </small> </div> ```
...
1. **Include the JavaScript** before the closing `</body>` tag of your HTML file:

    ```html
<script src="https://cdn.jsdelivr.net/npm/formique@1.2.4/formique.umd.min.js"></script>
    ```
