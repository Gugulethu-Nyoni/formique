...
function peg$parse(input, options) {
  ...
  var peg$f10 = function(markers, name, markers2) {
      return (markers || '') + name + (markers2 || '')
    };
  var peg$f11 = function(name, namePart, name2, type) {
  ...
  var peg$f19 = function(key, values) {
