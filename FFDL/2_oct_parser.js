...
function peg$parse(input, options) {
  ...
  function peg$f5() {    // Now allows @ symbols
  ...
  function peg$f20(key, values) {
    // FIX: Include the 'key' identifier in the AST node properties
    return createNode('OptionsAttribute', location().start, location().end, {
     key: key.value, // Extract the string value from the Identifier node
     values: values
    })
  }
