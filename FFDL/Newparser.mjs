...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$otherExpectation("form directiive must be in this format: @form: form-name");
  ...
  var peg$f3 = function() {  // Now allows @ symbols
  ...
  var peg$f18 = function(key, values) {
